...
int main() {
    ...
    // const Animal* meta = new Animal();  // Animal est une classe abstraite, donc on ne peut pas instancier un objet de cette classe
    ...
    // meta->makeSound();  // ipossible maintenant que Animal est une classe abstraite
    std::cout << std::endl;

    // Test 3 : Libération de la mémoire
    std::cout << "=== Test 3 : Libération de la mémoire ===" << std::endl;
    // delete meta; // meta n'existe pas
    delete dog1;
    delete cat1;
    std::cout << std::endl;
